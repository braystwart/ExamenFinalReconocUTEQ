...
import com.example.tensorflowapp.ml.UTEQLaMaria;
    ...
    public void Reconocimiento(View view){
        try {
            String[] etiquetas = {"Auditorio","Baños","Biblioteca","Centro Médico","Comedor","Facultad de Ciencias Agrarias y Forestales"
                    ...
                    "Laboratorio Agroindustrial","Laboratorio Industrial","Laboratorio de Suelos","Parqueadero","Polideportivo"};

            UTEQLaMaria model = UTEQLaMaria.newInstance(getApplicationContext());
            TensorBuffer inputFeature0 = TensorBuffer.createFixedSize(new int[]{1, 224, 224, 3}, DataType.FLOAT32);
            inputFeature0.loadBuffer(convertirImagenATensorBuffer(mSelectedImage));

            UTEQLaMaria.Outputs outputs = model.process(inputFeature0);
